...
public final class ReScueMatcher implements MatchResult {

    /**
     * The Pattern object that created this Matcher.
     */
    ReScuePattern parentPattern;
     ...
     */
    ReScueMatcher(ReScuePattern parent, CharSequence text, Trace trace) {
...
//        trace = new Trace(text.toString());
    ...
    public MatchResult toMatchResult() {
        ReScueMatcher result = new ReScueMatcher(this.parentPattern, text.toString(), this.trace);
    ...
    /**
      ...
      * @since 1.5
      */
    public ReScueMatcher usePattern(ReScuePattern newPattern) {
        if (newPattern == null)
     ...
     * @return  This matcher
     */
    public ReScueMatcher reset(CharSequence input) {
        text = input;
        return reset();
    }
    ...
    public Trace find(){    	
        ...
        if (nextSearchIndex > to) {
        	...
        	ReScuePattern.trace = this.trace;
        	trace_result = search(nextSearchIndex);
        	this.trace = ReScuePattern.trace;
        }
     ...
     * <code>appendReplacement</code> method of the {@link ReScueMatcher} class.
     ...
     */
    public ReScueMatcher appendReplacement(StringBuffer sb, String replacement) {
     ...
     * @since 1.5
     */
    public ReScueMatcher region(int start, int end) {
     ...
     * @since 1.5
     */
    public ReScueMatcher useTransparentBounds(boolean b) {
        transparentBounds = b;
        return this;
    }
     ...
     * @since 1.5
     */
    public ReScueMatcher useAnchoringBounds(boolean b) {
        anchoringBounds = b;
        return this;
    }
