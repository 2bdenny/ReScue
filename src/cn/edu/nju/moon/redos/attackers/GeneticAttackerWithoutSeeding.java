...
import cn.edu.nju.moon.redos.attackers.ga.initiators.RandomInitiator;
 ...
 */
public class GeneticAttackerWithoutSeeding extends RedosAttacker {	
	...
	public GeneticAttackerWithoutSeeding() {
		pop = new Population();
	}
	 ...
	 * @param g
	 */
	public GeneticAttackerWithoutSeeding(int sl, int ml, int pz, int g, double mp, double cp) {
		this();
	...
	public Trace attack(ReScuePattern jdkPattern) {		
		...
		Initiator initiator = new RandomInitiator(false);
